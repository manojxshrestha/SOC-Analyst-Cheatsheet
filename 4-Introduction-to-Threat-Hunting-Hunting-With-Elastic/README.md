...
Below is a brief description of the threat hunting process:
    ...
    Diagram with Adversary, Capability, Infrastructure, and Victim, including Meta-Features like Timestamp and Methodology.
...
Cyber Threat Intelligence requires Time, Actionable, Accurate, and Relevant information.
...
Diagram showing flow: Monitor internal and external reporting, Intelligence Assessment, Crisis Action Plans, Characterize and Problem and Disseminate.
...
Venn diagram with Strategic, Operational, and Tactical areas.
...
<img width="1104" height="216" alt="image" src="https://github.com/user-attachments/assets/4f5d4888-ec3f-4001-a49a-8782e7142207" />

Phishing email leads to OneNote file, then Batch file, PowerShell script in memory, and RAT executable for persistence.
...
Email titled 'Invoice #76' from Megazone Ltd. requesting payment for an outstanding invoice, with a link to view the invoice.
...
<img width="1425" height="1157" alt="image" src="https://github.com/user-attachments/assets/6fcd0a69-3799-4ea9-bc30-a4632fc7bbed" />


Elastic Stack Management settings: CSV separator, date format, timezone set to Europe/Copenhagen.
...
<img width="1170" height="700" alt="image" src="https://github.com/user-attachments/assets/6c185f3e-faac-4f5b-abbf-fa61eee4830a" />


Search results for event.code:15 and file.name:invoice.one, showing 3 hits with timestamps and document details.
...
<img width="1179" height="251" alt="image" src="https://github.com/user-attachments/assets/2bc10e53-104d-408c-bc48-7324c8ea7fc6" />


Log entry showing a file creation event on March 26, 2023, with event code 11. The file name is 'invoice.one:Zone.Identifier'. The agent hostname is WS001, using Winlogbeat version 8.6.0.
...
<img width="1172" height="163" alt="image" src="https://github.com/user-attachments/assets/a86ad1a3-e7dc-4801-899f-34b884032e63" />

Search query filtering DNS questions from source IP 192.168.28.130 on March 26, 2023, excluding specific domains like google.com and google-analytics.com.
...
<img width="1425" height="1184" alt="image" src="https://github.com/user-attachments/assets/450d428f-8686-4357-8a82-97baf5e29b66" />

Elastic search interface showing 332,261 hits for 'dns.question.name' over the last 15 years. Top 5 DNS values include signaler-pa.clients6.google.com at 12%, ssl.gstatic.com at 9%, and play.google.com at 6%.
...
<img width="1426" height="891" alt="image" src="https://github.com/user-attachments/assets/5f94fc8a-c049-4e8e-b818-16d4331c83ef" />

<img width="734" height="439" alt="image" src="https://github.com/user-attachments/assets/30200581-1abf-4e01-9189-34e810c6098e" />


Elastic search showing 232 DNS query hits from source IP 192.168.28.130 on March 26, 2023, excluding domains like google.com and google-analytics.com. Graph displays query frequency over time.Table showing 232 DNS query hits on March 26, 2023, with domains like ad-delivery.net, crt.usertrust.com, and track.venatusmedia.com.


Scrolling down the table of entries, we observe the following activities.

<img width="1116" height="938" alt="image" src="https://github.com/user-attachments/assets/06f83362-15bf-4a56-a604-491be94515a7" />

Table of 232 DNS hits on March 26, 2023, showing Defender SmartScreen scanning nav-edge.smartscreen.microsoft.com, file hosting at file.io, and email access at mail.google.com.
...
<img width="1163" height="511" alt="image" src="https://github.com/user-attachments/assets/dd309411-3e2a-4b7f-85ec-8510e3ec8e7b" />

Table showing 8 network traffic hits on March 26, 2023, with source IP 192.168.28.130 connecting to destination IP 34.197.10.85 on port 443.
...
<img width="1423" height="673" alt="image" src="https://github.com/user-attachments/assets/8939f9a1-7fe2-4883-8880-0919020008de" />

Elastic search showing 1 hit for event code 1 with command line containing 'invoice.c' over the last 15 years. No DNS question name is listed.
...
<img width="1172" height="314" alt="image" src="https://github.com/user-attachments/assets/373fe5d1-5f49-4cf9-be33-56a9e550139c" />


Elastic search showing 1 hit for event code 1 with command line 'invoice.one' over the last 15 years. Event details include timestamp March 26, 2023, at 22:05:53.601, hostname WS001, and process creation action.
...
<img width="1167" height="657" alt="image" src="https://github.com/user-attachments/assets/7ddbd223-9698-4a98-8615-615fa1951aeb" />


Table showing 3 process creation hits for ONENOTE.EXE on March 26, 2023, with event code 1. Hostname is WS001, using Winlogbeat version 8.6.0.
...
The results of this query present three hits. However, one of these (the bottom one) falls outside the relevant time frame and can be dismissed. Evaluating the other two results:
    ...
    <img width="1146" height="737" alt="image" src="https://github.com/user-attachments/assets/6384f4a6-d7ac-4c88-8e3f-9a15bffcfb44" />


Process details showing cmd.exe executing a batch file from OneNote export. Parent process is ONENOTE.EXE with command line referencing invoice.one.
...
<img width="1171" height="342" alt="image" src="https://github.com/user-attachments/assets/8c3d44ff-ff0a-4c19-a3d0-9ad58abdf465" />


Search query showing 1 hit for event code 1 with PowerShell execution. Process name is powershell.exe with arguments to execute a script from Pastebin.
...
<img width="1770" height="648" alt="image" src="https://github.com/user-attachments/assets/47c367ad-3eba-4530-af75-a1c0f47b9156" />

Search result showing 1 hit for event code 1 with PowerShell execution. Process name is powershell.exe with arguments to download from Pastebin. Process ID is 9944.
...
<img width="1164" height="811" alt="image" src="https://github.com/user-attachments/assets/97b7855c-98be-450d-8b9a-ac4a26623d2e" />


Search results showing 17 hits for process ID 9944 with PowerShell.exe. Event codes vary, including 1, 3, 11, and 4648. The first entry includes PowerShell arguments to download from Pastebin.
...
<img width="1159" height="763" alt="image" src="https://github.com/user-attachments/assets/aa3702f9-7296-457a-80ca-c072febbd393" />

Table showing 17 PowerShell.exe events on March 26, 2023. Includes password spraying script, EXE file drop, NGROK DNS, and Pastebin connections.
...
<img width="1174" height="761" alt="image" src="https://github.com/user-attachments/assets/1fbda42c-eec6-402c-9009-ddfb13ff9c3c" />

Table showing 24 network connections over the last 2 years. Source IP 192.168.28.130 frequently connects to destination IP 18.158.249.75 on port 443.
...
<img width="1172" height="633" alt="image" src="https://github.com/user-attachments/assets/e1a7b503-8f0b-4fa9-b7d1-3148b401ee90" />

Table showing 49 DNS query hits over the last 2 years. Source IP 192.168.28.132 frequently queries destination IP 192.168.28.200 on port 53, with some DNS answers including IPs like 3.125.102.39.

The newly discovered IP also indicates that connections continued consistently over the following days.

<img width="1168" height="1202" alt="image" src="https://github.com/user-attachments/assets/ff77c812-fadb-4a13-b0a0-2d025feff2af" />

Table showing 29 network connections. Source IPs 192.168.28.132 and 192.168.28.130 connect to destination IP 3.125.102.39 on port 443, with some connections to 192.168.28.2 on port 53.
...
<img width="1164" height="824" alt="image" src="https://github.com/user-attachments/assets/0349b190-7b42-4487-84c9-6fb1c6ccaac0" />


Table showing 68 hits for process 'default.exe'. Includes connections to IPs like 3.125.102.39 and 18.158.249.75. Notable file paths include C:\Users\Public\SharpHound.exe and C:\Users\bob\AppData\Local\Temp\svchost.exe.
...
<img width="977" height="551" alt="image" src="https://github.com/user-attachments/assets/755f278b-d352-44d8-9a69-f92cf14d40d4" />


Table showing 4 hits for SharpHound.exe on March 27, 2023. Includes arguments for collection method 'all'.
...
<img width="1851" height="942" alt="image" src="https://github.com/user-attachments/assets/da7e5041-6eba-4842-8931-d94b279c26da" />

Table showing 12 hits for process hash with default.exe and svchost.exe. File paths include C:\Users\svc-sql1\AppData\Local\Temp\svchost.exe. Hostnames are PKI and WS001.
...
<img width="1160" height="754" alt="image" src="https://github.com/user-attachments/assets/ec4a355d-7c07-4531-b424-1bc42b7ad299" />


Process creation log for default.exe with UTC timestamp March 27, 2023, at 22:18:12.402. Parent process is C:\Windows\PSEXESVC.exe. SHA256 hash is 018d37cbd3878258c29db3bc3f2988b6ae688843801b9abc28e6151141ab66d4.
...
<img width="1171" height="474" alt="image" src="https://github.com/user-attachments/assets/24b0a1aa-206c-4616-89e6-57e131a3312e" />


Table showing 6 logon events. Successful logons (event code 4624) for user svc-sql1 on hosts PKI and PAW. Failed logons (event code 4625) for user administrator on host DC1.
...
Recently uncovered details shed light on the operational strategy of Stuxbot's newest iteration.
    ...
    The newest iterations of Stuxbot are exploiting the C:\Users\Public directory as a conduit for deploying supplementary utilities.
    The newest iterations of Stuxbot are utilizing registry run keys as a mechanism to ensure their sustained presence within the infected system.
